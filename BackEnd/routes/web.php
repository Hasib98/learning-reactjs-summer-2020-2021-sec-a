...
Route::post('/userlist/{id}','ApiUser@store');
Route::put('/userlist/{id}','ApiUser@update');
Route::get('/userlist/delete/{id}','ApiUser@destroy');
Route::post('/userlist/insert/','ApiUser@store');
Route::post('/userlist/edit/{id}','ApiUser@update');

Route::get('/contents','ApiContent@index');
/* Route::post('/userlist/{id}','ApiUser@store');
Route::put('/userlist/{id}','ApiUser@update');
Route::get('/userlist/delete/{id}','ApiUser@destroy');
Route::post('/userlist/insert/','ApiUser@store');
