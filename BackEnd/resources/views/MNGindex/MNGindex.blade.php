                        ...
                        <table class="table table-image">
                            ...
                            <tbody>					
                                <tr>
                                    ...
                                    <td><a href="{{route('MNGpublish',$content['id'])}}"><button type="button" class="btn btn-primary">Publish</button></a></td>
                                    <td><a href="{{route('MNGdecline',$content['id'])}}"><button type="button" class="btn btn-primary">decline</button></a></td>
